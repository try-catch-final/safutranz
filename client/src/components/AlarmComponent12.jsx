...
const AlarmComponent12 = (props) => {
    ...
    const containerClass = `alarmcomponent12-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'AlarmComponent12'),
...
export default AlarmComponent12;
