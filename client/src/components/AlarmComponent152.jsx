...
const AlarmComponent152 = (props) => {
    ...
    const containerClass = `alarmcomponent152-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'AlarmComponent152'),
...
export default AlarmComponent152;
