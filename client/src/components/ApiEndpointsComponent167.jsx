...
const ApiEndpointsComponent167 = (props) => {
    ...
    const containerClass = `apiendpointscomponent167-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'ApiEndpointsComponent167'),
...
ApiEndpointsComponent167.propTypes = {
...
export default ApiEndpointsComponent167;
