...
const ApiEndpointsComponent22 = (props) => {
    ...
    const containerClass = `apiendpointscomponent22-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'ApiEndpointsComponent22'),
...
ApiEndpointsComponent22.propTypes = {
...
export default ApiEndpointsComponent22;
