...
const ApiEndpointsComponent7 = (props) => {
    ...
    const containerClass = `apiendpointscomponent7-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'ApiEndpointsComponent7'),
...
ApiEndpointsComponent7.propTypes = {
...
export default ApiEndpointsComponent7;
