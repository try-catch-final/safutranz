...
const ApiEndpointsComponent85 = (props) => {
    ...
    const containerClass = `apiendpointscomponent85-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'ApiEndpointsComponent85'),
...
ApiEndpointsComponent85.propTypes = {
...
export default ApiEndpointsComponent85;
