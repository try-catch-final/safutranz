...
const AuthComponent111 = (props) => {
    ...
    const containerClass = `authcomponent111-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'AuthComponent111'),
...
export default AuthComponent111;
