...
const AuthComponent27 = (props) => {
    ...
    const containerClass = `authcomponent27-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'AuthComponent27'),
...
export default AuthComponent27;
