...
const AuthComponent79 = (props) => {
    ...
    const containerClass = `authcomponent79-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'AuthComponent79'),
...
export default AuthComponent79;
