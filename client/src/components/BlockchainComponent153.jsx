...
const BlockchainComponent153 = (props) => {
    ...
    const containerClass = `blockchaincomponent153-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'BlockchainComponent153'),
...
BlockchainComponent153.propTypes = {
...
export default BlockchainComponent153;
