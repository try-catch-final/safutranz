...
const ConfigurationComponent132 = (props) => {
    ...
    const containerClass = `configurationcomponent132-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'ConfigurationComponent132'),
...
ConfigurationComponent132.propTypes = {
...
export default ConfigurationComponent132;
