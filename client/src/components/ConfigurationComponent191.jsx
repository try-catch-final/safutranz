...
const ConfigurationComponent191 = (props) => {
    ...
    const containerClass = `configurationcomponent191-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'ConfigurationComponent191'),
...
ConfigurationComponent191.propTypes = {
...
export default ConfigurationComponent191;
