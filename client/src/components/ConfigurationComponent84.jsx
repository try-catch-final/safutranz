...
const ConfigurationComponent84 = (props) => {
    ...
    const containerClass = `configurationcomponent84-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'ConfigurationComponent84'),
...
ConfigurationComponent84.propTypes = {
...
export default ConfigurationComponent84;
