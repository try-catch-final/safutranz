...
const DatabaseComponent104 = (props) => {
    ...
    const containerClass = `databasecomponent104-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'DatabaseComponent104'),
...
DatabaseComponent104.propTypes = {
...
export default DatabaseComponent104;
