...
const DatabaseComponent117 = (props) => {
    ...
    const containerClass = `databasecomponent117-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'DatabaseComponent117'),
...
DatabaseComponent117.propTypes = {
...
export default DatabaseComponent117;
