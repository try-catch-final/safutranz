...
const DatabaseComponent3 = (props) => {
    ...
    const containerClass = `databasecomponent3-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'DatabaseComponent3'),
...
export default DatabaseComponent3;
