...
const DatabaseComponent78 = (props) => {
    ...
    const containerClass = `databasecomponent78-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'DatabaseComponent78'),
...
export default DatabaseComponent78;
