...
const DatabaseComponent81 = (props) => {
    ...
    const containerClass = `databasecomponent81-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'DatabaseComponent81'),
...
export default DatabaseComponent81;
