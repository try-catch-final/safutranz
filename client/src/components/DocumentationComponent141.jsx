...
const DocumentationComponent141 = (props) => {
    ...
    const containerClass = `documentationcomponent141-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'DocumentationComponent141'),
...
DocumentationComponent141.propTypes = {
...
export default DocumentationComponent141;
