...
const DocumentationComponent151 = (props) => {
    ...
    const containerClass = `documentationcomponent151-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'DocumentationComponent151'),
...
DocumentationComponent151.propTypes = {
...
export default DocumentationComponent151;
