...
const DocumentationComponent29 = (props) => {
    ...
    const containerClass = `documentationcomponent29-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'DocumentationComponent29'),
...
DocumentationComponent29.propTypes = {
...
export default DocumentationComponent29;
