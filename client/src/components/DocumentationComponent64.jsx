...
const DocumentationComponent64 = (props) => {
    ...
    const containerClass = `documentationcomponent64-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'DocumentationComponent64'),
...
DocumentationComponent64.propTypes = {
...
export default DocumentationComponent64;
