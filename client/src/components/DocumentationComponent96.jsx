...
const DocumentationComponent96 = (props) => {
    ...
    const containerClass = `documentationcomponent96-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'DocumentationComponent96'),
...
DocumentationComponent96.propTypes = {
...
export default DocumentationComponent96;
