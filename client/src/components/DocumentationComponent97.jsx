...
const DocumentationComponent97 = (props) => {
    ...
    const containerClass = `documentationcomponent97-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'DocumentationComponent97'),
...
DocumentationComponent97.propTypes = {
...
export default DocumentationComponent97;
