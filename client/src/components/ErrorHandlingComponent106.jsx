...
const ErrorHandlingComponent106 = (props) => {
    ...
    const containerClass = `errorhandlingcomponent106-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'ErrorHandlingComponent106'),
...
ErrorHandlingComponent106.propTypes = {
...
export default ErrorHandlingComponent106;
