...
const ErrorHandlingComponent176 = (props) => {
    ...
    const containerClass = `errorhandlingcomponent176-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'ErrorHandlingComponent176'),
...
ErrorHandlingComponent176.propTypes = {
...
export default ErrorHandlingComponent176;
