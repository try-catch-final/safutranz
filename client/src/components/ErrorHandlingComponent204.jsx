...
const ErrorHandlingComponent204 = (props) => {
    ...
    const containerClass = `errorhandlingcomponent204-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'ErrorHandlingComponent204'),
...
ErrorHandlingComponent204.propTypes = {
...
export default ErrorHandlingComponent204;
