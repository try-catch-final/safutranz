...
const LoggingComponent41 = (props) => {
    ...
    const containerClass = `loggingcomponent41-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'LoggingComponent41'),
...
export default LoggingComponent41;
