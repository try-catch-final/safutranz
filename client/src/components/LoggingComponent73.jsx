...
const LoggingComponent73 = (props) => {
    ...
    const containerClass = `loggingcomponent73-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'LoggingComponent73'),
...
export default LoggingComponent73;
