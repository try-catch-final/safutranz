...
const PerformanceComponent100 = (props) => {
    ...
    const containerClass = `performancecomponent100-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'PerformanceComponent100'),
...
PerformanceComponent100.propTypes = {
...
export default PerformanceComponent100;
