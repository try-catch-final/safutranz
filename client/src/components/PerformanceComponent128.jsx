...
const PerformanceComponent128 = (props) => {
    ...
    const containerClass = `performancecomponent128-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'PerformanceComponent128'),
...
PerformanceComponent128.propTypes = {
...
export default PerformanceComponent128;
