...
const PerformanceComponent130 = (props) => {
    ...
    const containerClass = `performancecomponent130-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'PerformanceComponent130'),
...
PerformanceComponent130.propTypes = {
...
export default PerformanceComponent130;
