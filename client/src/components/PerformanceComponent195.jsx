...
const PerformanceComponent195 = (props) => {
    ...
    const containerClass = `performancecomponent195-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'PerformanceComponent195'),
...
PerformanceComponent195.propTypes = {
...
export default PerformanceComponent195;
