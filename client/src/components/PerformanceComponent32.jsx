...
const PerformanceComponent32 = (props) => {
    ...
    const containerClass = `performancecomponent32-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'PerformanceComponent32'),
...
PerformanceComponent32.propTypes = {
...
export default PerformanceComponent32;
