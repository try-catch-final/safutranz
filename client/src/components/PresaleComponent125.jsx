...
const PresaleComponent125 = (props) => {
    ...
    const containerClass = `presalecomponent125-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'PresaleComponent125'),
...
export default PresaleComponent125;
