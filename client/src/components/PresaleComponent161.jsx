...
const PresaleComponent161 = (props) => {
    ...
    const containerClass = `presalecomponent161-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'PresaleComponent161'),
...
export default PresaleComponent161;
