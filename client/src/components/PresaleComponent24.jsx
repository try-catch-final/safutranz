...
const PresaleComponent24 = (props) => {
    ...
    const containerClass = `presalecomponent24-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'PresaleComponent24'),
...
export default PresaleComponent24;
