...
const SecurityComponent71 = (props) => {
    ...
    const containerClass = `securitycomponent71-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'SecurityComponent71'),
...
export default SecurityComponent71;
