...
const TestingComponent148 = (props) => {
    ...
    const containerClass = `testingcomponent148-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'TestingComponent148'),
...
export default TestingComponent148;
