...
const TestingComponent51 = (props) => {
    ...
    const containerClass = `testingcomponent51-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'TestingComponent51'),
...
export default TestingComponent51;
