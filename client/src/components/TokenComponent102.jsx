...
const TokenComponent102 = (props) => {
    ...
    const containerClass = `tokencomponent102-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'TokenComponent102'),
...
export default TokenComponent102;
