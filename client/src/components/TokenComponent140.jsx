...
const TokenComponent140 = (props) => {
    ...
    const containerClass = `tokencomponent140-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'TokenComponent140'),
...
export default TokenComponent140;
