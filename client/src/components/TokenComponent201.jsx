...
const TokenComponent201 = (props) => {
    ...
    const containerClass = `tokencomponent201-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'TokenComponent201'),
...
export default TokenComponent201;
