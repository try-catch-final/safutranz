...
const TokenComponent37 = (props) => {
    ...
    const containerClass = `tokencomponent37-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'TokenComponent37'),
...
export default TokenComponent37;
