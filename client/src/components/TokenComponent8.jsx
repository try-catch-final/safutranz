...
const TokenComponent8 = (props) => {
    ...
    const containerClass = `tokencomponent8-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'TokenComponent8'),
...
export default TokenComponent8;
