...
const UserInterfaceComponent121 = (props) => {
    ...
    const containerClass = `userinterfacecomponent121-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'UserInterfaceComponent121'),
...
UserInterfaceComponent121.propTypes = {
...
export default UserInterfaceComponent121;
