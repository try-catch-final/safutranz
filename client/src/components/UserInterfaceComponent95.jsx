...
const UserInterfaceComponent95 = (props) => {
    ...
    const containerClass = `userinterfacecomponent95-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'UserInterfaceComponent95'),
...
UserInterfaceComponent95.propTypes = {
...
export default UserInterfaceComponent95;
