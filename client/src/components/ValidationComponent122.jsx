...
const ValidationComponent122 = (props) => {
    ...
    const containerClass = `validationcomponent122-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'ValidationComponent122'),
...
ValidationComponent122.propTypes = {
...
export default ValidationComponent122;
