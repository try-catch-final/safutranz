...
const ValidationComponent143 = (props) => {
    ...
    const containerClass = `validationcomponent143-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'ValidationComponent143'),
...
ValidationComponent143.propTypes = {
...
export default ValidationComponent143;
