...
const ValidationComponent57 = (props) => {
    ...
    const containerClass = `validationcomponent57-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'ValidationComponent57'),
...
ValidationComponent57.propTypes = {
...
export default ValidationComponent57;
