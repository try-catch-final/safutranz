...
const WalletComponent21 = (props) => {
    ...
    const containerClass = `walletcomponent21-container ${className}`;
    
    return React.createElement('div', { className: containerClass }, 
        React.createElement('div', { className: 'header' },
            React.createElement('h2', null, 'WalletComponent21'),
...
export default WalletComponent21;
