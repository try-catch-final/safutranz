...
var valNetState = '';
class FairLaunch2 extends Component {
	constructor(props) {
		super(props);
								...
								<form>
									...
									<div className="has-text-centered">
										<div className="has-text-info p-4">
											Need {this.state.softCap * this.state.presaleRate}{' '}
...
export default connect(mapStateToProps, { setWhiteListData, setReduxValue })(FairLaunch2);
