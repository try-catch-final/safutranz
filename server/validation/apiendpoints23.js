...
const apiendpoints23Validation = {
    create: [
        body('name')
            .trim()
            ...
            .custom(async (value) => {
                const existing = await ApiEndpoints23Model.findOne({ name: value });
                if (existing) {
...
module.exports = {
    apiendpoints23Validation,
    apiendpoints23Sanitizer
};
