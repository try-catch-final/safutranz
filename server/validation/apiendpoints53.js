...
const apiendpoints53Validation = {
    create: [
        body('name')
            .trim()
            ...
            .custom(async (value) => {
                const existing = await ApiEndpoints53Model.findOne({ name: value });
                if (existing) {
...
module.exports = {
    apiendpoints53Validation,
    apiendpoints53Sanitizer
};
