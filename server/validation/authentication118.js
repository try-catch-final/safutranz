...
const authentication118Validation = {
    create: [
        body('name')
            .trim()
            ...
            .custom(async (value) => {
                const existing = await Authentication118Model.findOne({ name: value });
                if (existing) {
...
const authentication118Sanitizer = {
    sanitizeInput: (data) => {
        const sanitized = {};
...
module.exports = {
    authentication118Validation,
    authentication118Sanitizer
};
