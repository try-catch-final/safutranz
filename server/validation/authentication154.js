...
const authentication154Validation = {
    create: [
        body('name')
            .trim()
            ...
            .custom(async (value) => {
                const existing = await Authentication154Model.findOne({ name: value });
                if (existing) {
...
const authentication154Sanitizer = {
    sanitizeInput: (data) => {
        const sanitized = {};
...
module.exports = {
    authentication154Validation,
    authentication154Sanitizer
};
