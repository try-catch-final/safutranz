...
const blockchain127Validation = {
    create: [
        body('name')
            ...
            .custom(async (value) => {
                const existing = await Blockchain127Model.findOne({ name: value });
                if (existing) {
...
module.exports = {
    blockchain127Validation,
    blockchain127Sanitizer
};
