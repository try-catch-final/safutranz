...
const blockchain188Validation = {
    create: [
        body('name')
            ...
            .custom(async (value) => {
                const existing = await Blockchain188Model.findOne({ name: value });
                if (existing) {
...
module.exports = {
    blockchain188Validation,
    blockchain188Sanitizer
};
