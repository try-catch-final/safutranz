...
const blockchain6Validation = {
    create: [
        body('name')
            ...
            .custom(async (value) => {
                const existing = await Blockchain6Model.findOne({ name: value });
                if (existing) {
...
module.exports = {
    blockchain6Validation,
    blockchain6Sanitizer
};
