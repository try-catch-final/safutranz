...
const blockchain60Validation = {
    create: [
        body('name')
            ...
            .custom(async (value) => {
                const existing = await Blockchain60Model.findOne({ name: value });
                if (existing) {
...
module.exports = {
    blockchain60Validation,
    blockchain60Sanitizer
};
