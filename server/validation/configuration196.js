...
const configuration196Validation = {
    create: [
        body('name')
            .trim()
            ...
            .custom(async (value) => {
                const existing = await Configuration196Model.findOne({ name: value });
                if (existing) {
...
const configuration196Sanitizer = {
    sanitizeInput: (data) => {
        const sanitized = {};
...
module.exports = {
    configuration196Validation,
    configuration196Sanitizer
};
