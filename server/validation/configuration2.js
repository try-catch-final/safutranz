...
const configuration2Validation = {
    create: [
        body('name')
            .trim()
            ...
            .custom(async (value) => {
                const existing = await Configuration2Model.findOne({ name: value });
                if (existing) {
...
module.exports = {
    configuration2Validation,
    configuration2Sanitizer
};
