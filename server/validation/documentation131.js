...
const documentation131Validation = {
    create: [
        body('name')
            .trim()
            ...
            .custom(async (value) => {
                const existing = await Documentation131Model.findOne({ name: value });
                if (existing) {
...
const documentation131Sanitizer = {
    sanitizeInput: (data) => {
        const sanitized = {};
...
module.exports = {
    documentation131Validation,
    documentation131Sanitizer
};
