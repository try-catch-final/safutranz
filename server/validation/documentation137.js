...
const documentation137Validation = {
    create: [
        body('name')
            .trim()
            ...
            .custom(async (value) => {
                const existing = await Documentation137Model.findOne({ name: value });
                if (existing) {
...
const documentation137Sanitizer = {
    sanitizeInput: (data) => {
        const sanitized = {};
...
module.exports = {
    documentation137Validation,
    documentation137Sanitizer
};
