...
const errorhandling124Validation = {
    create: [
        body('name')
            .trim()
            ...
            .custom(async (value) => {
                const existing = await ErrorHandling124Model.findOne({ name: value });
                if (existing) {
...
const errorhandling124Sanitizer = {
    sanitizeInput: (data) => {
        const sanitized = {};
...
module.exports = {
    errorhandling124Validation,
    errorhandling124Sanitizer
};
