...
const errorhandling133Validation = {
    create: [
        body('name')
            .trim()
            ...
            .custom(async (value) => {
                const existing = await ErrorHandling133Model.findOne({ name: value });
                if (existing) {
...
const errorhandling133Sanitizer = {
    sanitizeInput: (data) => {
        const sanitized = {};
...
module.exports = {
    errorhandling133Validation,
    errorhandling133Sanitizer
};
