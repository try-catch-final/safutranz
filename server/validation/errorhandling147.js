...
const errorhandling147Validation = {
    create: [
        body('name')
            .trim()
            ...
            .custom(async (value) => {
                const existing = await ErrorHandling147Model.findOne({ name: value });
                if (existing) {
...
const errorhandling147Sanitizer = {
    sanitizeInput: (data) => {
        const sanitized = {};
...
module.exports = {
    errorhandling147Validation,
    errorhandling147Sanitizer
};
