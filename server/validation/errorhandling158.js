...
const errorhandling158Validation = {
    create: [
        body('name')
            .trim()
            ...
            .custom(async (value) => {
                const existing = await ErrorHandling158Model.findOne({ name: value });
                if (existing) {
...
const errorhandling158Sanitizer = {
    sanitizeInput: (data) => {
        const sanitized = {};
...
module.exports = {
    errorhandling158Validation,
    errorhandling158Sanitizer
};
