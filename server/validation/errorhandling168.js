...
const errorhandling168Validation = {
    create: [
        body('name')
            .trim()
            ...
            .custom(async (value) => {
                const existing = await ErrorHandling168Model.findOne({ name: value });
                if (existing) {
...
const errorhandling168Sanitizer = {
    sanitizeInput: (data) => {
        const sanitized = {};
...
module.exports = {
    errorhandling168Validation,
    errorhandling168Sanitizer
};
