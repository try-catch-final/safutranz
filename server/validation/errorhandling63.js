...
const errorhandling63Validation = {
    create: [
        body('name')
            .trim()
            ...
            .custom(async (value) => {
                const existing = await ErrorHandling63Model.findOne({ name: value });
                if (existing) {
...
const errorhandling63Sanitizer = {
    sanitizeInput: (data) => {
        const sanitized = {};
...
module.exports = {
    errorhandling63Validation,
    errorhandling63Sanitizer
};
