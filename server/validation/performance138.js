...
const performance138Validation = {
    create: [
        body('name')
            .trim()
            ...
            .custom(async (value) => {
                const existing = await Performance138Model.findOne({ name: value });
                if (existing) {
...
module.exports = {
    performance138Validation,
    performance138Sanitizer
};
