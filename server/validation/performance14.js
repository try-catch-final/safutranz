...
const performance14Validation = {
    create: [
        body('name')
            ...
            .custom(async (value) => {
                const existing = await Performance14Model.findOne({ name: value });
                if (existing) {
...
module.exports = {
    performance14Validation,
    performance14Sanitizer
};
