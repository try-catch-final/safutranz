...
const performance173Validation = {
    create: [
        body('name')
            .trim()
            ...
            .custom(async (value) => {
                const existing = await Performance173Model.findOne({ name: value });
                if (existing) {
...
module.exports = {
    performance173Validation,
    performance173Sanitizer
};
