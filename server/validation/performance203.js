...
const performance203Validation = {
    create: [
        body('name')
            .trim()
            ...
            .custom(async (value) => {
                const existing = await Performance203Model.findOne({ name: value });
                if (existing) {
...
module.exports = {
    performance203Validation,
    performance203Sanitizer
};
