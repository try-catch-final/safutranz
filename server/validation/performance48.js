...
const performance48Validation = {
    create: [
        body('name')
            ...
            .custom(async (value) => {
                const existing = await Performance48Model.findOne({ name: value });
                if (existing) {
...
module.exports = {
    performance48Validation,
    performance48Sanitizer
};
