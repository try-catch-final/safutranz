...
const security105Validation = {
    create: [
        body('name')
            ...
            .custom(async (value) => {
                const existing = await Security105Model.findOne({ name: value });
                if (existing) {
...
module.exports = {
    security105Validation,
    security105Sanitizer
};
