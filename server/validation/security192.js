...
const security192Validation = {
    create: [
        body('name')
            ...
            .custom(async (value) => {
                const existing = await Security192Model.findOne({ name: value });
                if (existing) {
...
module.exports = {
    security192Validation,
    security192Sanitizer
};
