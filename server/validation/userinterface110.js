...
const userinterface110Validation = {
    create: [
        body('name')
            .trim()
            ...
            .custom(async (value) => {
                const existing = await UserInterface110Model.findOne({ name: value });
                if (existing) {
...
const userinterface110Sanitizer = {
    sanitizeInput: (data) => {
        const sanitized = {};
...
module.exports = {
    userinterface110Validation,
    userinterface110Sanitizer
};
