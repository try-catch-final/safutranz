...
const userinterface189Validation = {
    create: [
        body('name')
            .trim()
            ...
            .custom(async (value) => {
                const existing = await UserInterface189Model.findOne({ name: value });
                if (existing) {
...
const userinterface189Sanitizer = {
    sanitizeInput: (data) => {
        const sanitized = {};
...
module.exports = {
    userinterface189Validation,
    userinterface189Sanitizer
};
