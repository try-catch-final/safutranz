...
const userinterface5Validation = {
    create: [
        body('name')
            .trim()
            ...
            .custom(async (value) => {
                const existing = await UserInterface5Model.findOne({ name: value });
                if (existing) {
...
module.exports = {
    userinterface5Validation,
    userinterface5Sanitizer
};
