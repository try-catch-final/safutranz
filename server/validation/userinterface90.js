...
const userinterface90Validation = {
    create: [
        body('name')
            .trim()
            ...
            .custom(async (value) => {
                const existing = await UserInterface90Model.findOne({ name: value });
                if (existing) {
...
const userinterface90Sanitizer = {
    sanitizeInput: (data) => {
        const sanitized = {};
...
module.exports = {
    userinterface90Validation,
    userinterface90Sanitizer
};
