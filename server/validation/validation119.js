...
const validation119Validation = {
    create: [
        body('name')
            ...
            .custom(async (value) => {
                const existing = await Validation119Model.findOne({ name: value });
                if (existing) {
...
module.exports = {
    validation119Validation,
    validation119Sanitizer
};
