...
const validation9Validation = {
    create: [
        body('name')
            ...
            .custom(async (value) => {
                const existing = await Validation9Model.findOne({ name: value });
                if (existing) {
...
module.exports = {
    validation9Validation,
    validation9Sanitizer
};
