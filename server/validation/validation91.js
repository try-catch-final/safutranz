...
const validation91Validation = {
    create: [
        body('name')
            ...
            .custom(async (value) => {
                const existing = await Validation91Model.findOne({ name: value });
                if (existing) {
...
module.exports = {
    validation91Validation,
    validation91Sanitizer
};
